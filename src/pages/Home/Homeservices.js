...
class HomeServices extends Component {
  componentDidMount() {
    $('.yugen-face_box').click(() => {;
      $('.child1').slideToggle();
      $('.child2').hide();
      $('.child3').hide();
      $('.child4').hide();
      $('.row1 .col-xl-3 .hs_box').removeClass('active');
      $('.yugen-face_box .hs_box').addClass('active');
      $('.yugen-face .servcies-list').toggleClass('d-block');
    });
    $('.yugen-body_box').click(() => {
      $('.child2').slideToggle();
      $('.child1').hide();
      $('.child3').hide();
      $('.child4').hide();
      $('.row1 .col-xl-3 .hs_box').removeClass('active');
      $('.yugen-body_box .hs_box').addClass('active');
      $('.yugen-body .servcies-list').toggleClass('d-block');
    });
    $('.yugen-health_box').click(() => {
      $('.child3').slideToggle();
      $('.child1').hide();
      $('.child2').hide();
      $('.child4').hide();
      ...
      $('.yugen-health .servcies-list').toggleClass('d-block');
    });
    $('.yugen-wellbeing_box').click(() => {
      $('.child4').slideToggle();
      $('.child1').hide();
      $('.child2').hide();
      $('.child3').hide();
      ...
      $('.yugen-wellbeing .servcies-list').toggleClass('d-block');
    });
    $('.yugen-anti-aging_box').click(() => {;
      $('.child5').slideToggle();
      $('.child6').hide();
      $('.child7').hide();
      $('.child8').hide();
      ...
      $('.yugen-anti-aging .servcies-list').toggleClass('d-block');
    });
    $('.yugen-man_box').click(() => {;
      $('.child6').slideToggle();
      $('.child5').hide();
      ...
      $('.child8').hide();
      $('.row2 .col-xl-3 .hs_box').removeClass('active');
      $('.yugen-man .hs_box').addClass('active');
      $('.yugen-man .servcies-list').toggleClass('d-block');
    });
    $('.yugen-sensual_box').click(() => {;
      $('.child7').slideToggle();
      $('.child5').hide();
      $('.child6').hide();
      $('.child8').hide();
      $('.row2 .col-xl-3 .hs_box').removeClass('active');
      $('.yugen-sensual .hs_box').addClass('active');
      $('.yugen-sensual .servcies-list').toggleClass('d-block');
    });
    $('.yugen-dental_box').click(() => {;
      $('.child8').slideToggle();
      $('.child5').hide();
      $('.child6').hide();
      $('.child7').hide();
      $('.row2 .col-xl-3 .hs_box').removeClass('active');
      $('.yugen-dental .hs_box').addClass('active');
      $('.yugen-dental .servcies-list').toggleClass('d-block');
    });
  }
  render(){
    return(
      <div className="HomeServices content-block1 position-relative d-none d-sm-block">
        <div className="row1">
